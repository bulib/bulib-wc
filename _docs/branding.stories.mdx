...
- **[header](?path=/docs/branding-header)**: top and primary navigation that is seen every time a user is on any page
- **[footer](?path=/docs/branding-bulib-footer)**: anchors the bottom of the page, sandwiches content, provides fallback/quick links, IA, SEO
...
- **[colors](?path=/docs/branding-colors)**: the array of colors used to highlight, differentiate, or decorate between sites
